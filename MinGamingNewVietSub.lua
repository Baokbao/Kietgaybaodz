...
local Window = OrionLib:MakeWindow({Name = "banana hub", HidePremium = false, IntroText = "By gia bao", SaveConfig = true, ConfigFolder = "banana Hub"})
----------Tab-----------------------
local W = Window:MakeTab({
    Name = "Thông Tin",
    Icon = "rbxassetid://15849136476",
    PremiumOnly = false
})
...
elseif World3 then
	tableBoss = {"banana Raid Boss [Lv. 3000]","Stone","Island Empress","Kilo Admiral","Captain Elephant","Beautiful Pirate","rip_indra True Form","Longma","Soul Reaper","Cake Queen"}
end
        ...
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    ...
                    Image = "rbxassetid://15849136476",
                    Time = 9
                })
                OrionLib:MakeNotification({
                    Name = "bananaHub(Noitification)",
